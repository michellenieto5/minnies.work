...
const projects = [
    ...
    { image: "/images/treasure2.png", title: "Binary Bomb Lab - x86 Reverse Engineering", year: "2025", role: "Reverse Engineer",  technologies: "QEMU, GDB, Assembly Language, Kali Linux", desc: "This project was a binary “bomb lab” where I had to reverse-engineer a compiled 32 bit program and defuse six phases by discovering the exact inputs it expected.", href: "/projects/bomblab" },
