...
const projects = [
    ...
    { image: "/images/treasure2.png", title: "Binary Bomb Lab - x86 Reverse Engineering", year: "2025", role: "Reverse Engineer",  technologies: "QEMU, GDB, Assembly Language, Kali Linux", desc: "This project was a classic binary “bomb lab” where I had to reverse-engineer a compiled 32 bit program and defuse six phases by discovering the exact inputs it expected.", href: "/projects/bomblab" },
    ...
    { image: "/images/treasure2.png", title: "Treasure Hunt Mobile App", year: "2024", role: "Developer",  technologies: "Kotlin", desc: "An Android app for geo-located puzzles that turn city exploration into an interactive game.", href: "/projects/treasure-hunt-mobile" },
